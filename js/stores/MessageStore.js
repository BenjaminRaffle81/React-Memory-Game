...
var _messages = {
    choosetile: 'Choose a Z Fighter!',
    findmate: 'Now try to find the matching Z Fighter!',
    wrong: 'Sorry, those didn\'t match, dummy!',
    foundmate: 'Hooray, they matched!',
    foundall: 'You\'ve found all pairs! Time to power up!'
};
